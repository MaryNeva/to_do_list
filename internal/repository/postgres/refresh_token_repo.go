...
// handleUnusable classifies a token that could not be consumed. For any
// already revoked token it revokes all of the user's tokens in tx and returns
// ErrTokenReuse; the caller commits.
